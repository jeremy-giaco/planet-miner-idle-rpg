...
local TUNABLES = {
    -- Movement
    GRAVITY                   = { min = 0,    max = 1e6,  isServer = true,
        apply = function(v) workspace.Gravity = v end },
    WALK_SPEED                = { min = 0,    max = 1e6,  isServer = false },
    RUN_SPEED                 = { min = 0,    max = 1e6,  isServer = false },
    JUMP_POWER                = { min = 0,    max = 1e6,  isServer = false },
    -- Jetpack
    JETPACK_THRUST            = { min = 0,    max = 1e6,  isServer = false },
    JETPACK_FORWARD_THRUST    = { min = 0,    max = 1e6,  isServer = false },
    JETPACK_MAX_UP_SPEED      = { min = 0,    max = 1e6,  isServer = false },
    JETPACK_MAX_HORIZ_SPEED   = { min = 0,    max = 1e6,  isServer = false },
    JETPACK_ACTIVATION_DELAY  = { min = 0,    max = 1e6,  isServer = false },
    -- Laser
    LASER_DAMAGE              = { min = 0,    max = 1e6,  isServer = false },
    LASER_RANGE               = { min = 0,    max = 1e6,  isServer = false },
    LASER_COOLDOWN            = { min = 0,    max = 1e6,  isServer = false },
    -- Shield
    SHIELD_RADIUS             = { min = 0,    max = 1e6,  isServer = false },
    SHIELD_ENERGY_MAX         = { min = 0,    max = 1e6,  isServer = false },
    SHIELD_ENERGY_DRAIN       = { min = 0,    max = 1e6,  isServer = false },
    SHIELD_RECHARGE_RATE      = { min = 0,    max = 1e6,  isServer = false },
    SHIELD_DAMAGE             = { min = 0,    max = 1e6,  isServer = false },
    -- Tachyite
    TACHYITE_DROP_CHANCE      = { min = 0,    max = 1,    isServer = false },
    TACHYITE_SPEED_BONUS      = { min = 0,    max = 1e6,  isServer = false },
    TACHYITE_DURATION         = { min = 0,    max = 1e6,  isServer = false },
    -- Debris
    DEBRIS_SPAWN_INTERVAL     = { min = 0,    max = 1e6,  isServer = false },
    DEBRIS_SPAWN_PER_WAVE     = { min = 0,    max = 1e6,  isServer = false },
    DEBRIS_INITIAL_BURST      = { min = 0,    max = 1e6,  isServer = false },
    DEBRIS_SPEED              = { min = 0,    max = 1e6,  isServer = false },
    DEBRIS_SPAWN_HEIGHT       = { min = 0,    max = 1e6,  isServer = false },
    DEBRIS_HEALTH             = { min = 0,    max = 1e6,  isServer = false },
    DEBRIS_LIFETIME           = { min = 0,    max = 1e6,  isServer = false },
    DEBRIS_HIT_COOLDOWN       = { min = 0,    max = 1e6,  isServer = false },
    DEBRIS_DEATH_PIECES       = { min = 0,    max = 1e6,  isServer = false },
    DEBRIS_CARGO_CHANCE       = { min = 0,    max = 1,    isServer = false },
    DEBRIS_COLLECT_RADIUS     = { min = 0,    max = 1e6,  isServer = false },
    -- Collection
    ORE_MAGNET_RADIUS         = { min = 0,    max = 1e6,  isServer = false },
    ORE_COLLECT_RADIUS        = { min = 0,    max = 1e6,  isServer = false },
    COLLECTIBLE_LIFETIME      = { min = 0,    max = 1e6,  isServer = false },
    COLLECTIBLE_ROTATION_SPEED= { min = 0,    max = 1e6,  isServer = false },
    -- Ore spawning
    ORE_SPAWN_INTERVAL        = { min = 0,    max = 1e6,  isServer = false },
    ORE_MAX_COUNT             = { min = 0,    max = 1e6,  isServer = false },
    -- Drones
    DRONE_SPEED               = { min = 0,    max = 1e6,  isServer = false },
    DRONE_CARGO_CAPACITY      = { min = 0,    max = 1e6,  isServer = false },
    DRONE_GUN_RANGE           = { min = 0,    max = 1e6,  isServer = false },
    DRONE_GUN_COOLDOWN        = { min = 0,    max = 1e6,  isServer = false },
    DRONE_GUN_DAMAGE          = { min = 0,    max = 1e6,  isServer = false },
    DRONE_GUARD_RADIUS        = { min = 0,    max = 1e6,  isServer = false },
    DRONE_GUARD_HEIGHT        = { min = 0,    max = 1e6,  isServer = false },
    DRONE_MAX_HEALTH          = { min = 0,    max = 1e6,  isServer = false },
    DRONE_DEBRIS_DAMAGE       = { min = 0,    max = 1e6,  isServer = false },
    DRONE_REPAIR_THRESHOLD    = { min = 0,    max = 1e6,  isServer = false },
    DRONE_REPAIR_RATE         = { min = 0,    max = 1e6,  isServer = false },
    ROVER_HOVER_HEIGHT        = { min = 0,    max = 1e6,  isServer = false },
}
